...
├── public/            # llms.txt, llms-concepts.txt, llms-full.txt, robots.txt
...
# created on or after RECORD_START (the date the per-page fields were introduced).
...
- **`llms-concepts.txt`** — full text of the concept and FAQ pages, about 4 MB: the file to hand a chat that rejects the larger one
