...
The [[guardrails|guardrail]] is to **use AI as a scaffold, not a substitute** — keep the learner doing the cognitively important work while AI provides support — and to watch the full range of impacts (cognitive, motivational, [[affective-computing|affective]], identity, social, and [[equity-in-ai-education|equity]]), not just performance. For a deeper treatment organized by dimension, see the [[student-experience|Student Experience]] concept page.
