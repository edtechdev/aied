...
- **Administrators.** Treat policy harmonization as insufficient and check enforcement for cultural bias, since identical behavior judged differently across a diverse cohort is an [[equity-in-ai-education]] problem rather than a compliance one.
