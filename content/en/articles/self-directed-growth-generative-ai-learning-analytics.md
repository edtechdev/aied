...
technology: [generative-ai, learning-analytics, personalized-learning]
...
- **Self-Directed Growth as a distinct competency.** The paper defines it as a learner's capacity to drive continuous and sustainable [[self-directed-learning|self-directed learning]] (SDL) cycles across diverse tasks and contexts, positioning the learner as initiator, executor, assessor, and primary agent of their own journey. It is framed as an advanced extension of [[self-regulated-learning|self-directed learning]] oriented toward self-actualization and an internal compass rather than predefined task outcomes.
