---
title: "Which inference is at risk? Assessment validity reasoning and generative AI"
created: "2026-09-21T08:06:13-04:00"
updated: "2026-09-21T08:06:13-04:00"
type: article
sources: ['raw/papers/weidlich-inference-at-risk-assessment-validity-2026.md']
confidence: medium
published: "2026-09-20"
page_kind: [framework]
research_method: [theoretical analysis]
level: [higher ed]
audience: [assessment designers, assessment professionals, instructors, administrators]
...
1. **The same symptom admits several diagnoses.** A gap between an AI-permitted essay and a supervised oral establishes neither misconduct nor competence: it can indicate [[academic-integrity|construct underrepresentation]], [[assessment-validity|construct-irrelevant variance]], an attribution problem, a mismatch between performances, or an unclear rule for combining evidence.
2. **AI use is not automatically a threat to validity.** If the construct is AI-supported professional judgment, tool use is germane to it; if the construct is unaided disciplinary reasoning, the same use bypasses the target performance, so construct and AI conditions must be specified together.
3. **Detection adds construct-irrelevant variance rather than removing it.** Detector performance varies across tasks, disciplines and model versions, and disclosed or suspected AI use can act as a biasing cue for markers, so a security response can contaminate score meaning and fairness.
