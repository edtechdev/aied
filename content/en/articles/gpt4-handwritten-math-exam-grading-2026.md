...
4. Grading without a rubric was clearly worse: accuracy 0.50 and alpha 0.32 when taking a single GPT-4 judgment, 0.51 and 0.34 under majority or averaged aggregation, against 0.69 and 0.60 for the best rubric-based approach.
...
## Exam design and grading-rule implications
...
Third, language proved not to be a barrier in these experiments: German and English graded at comparable accuracy and no explicit translation step was needed, though the authors caution that this does not generalize to less widely represented languages.

Fourth, the authors report preliminary follow-up evidence that GPT-4o interprets handwritten mathematical expressions better than GPT-4V, which suggests the transcription half of the pipeline is improving faster than the judgment half.
