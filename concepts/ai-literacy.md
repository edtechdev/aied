...
**2. Sequence learners through rising levels of cognitive engagement.** Applying the [[icap-framework|ICAP framework]], effective instruction intentionally moves students from passive exposure (AI concept lectures) through active manipulation (hands-on tool use), constructive generation (creating AI artifacts, self-explaining), and interactive dialogue (collaborative problem-solving with peers and AI). A systematic review found successful collaborative AI-literacy interventions spanned all four ICAP modes — no single mode sufficed.^[[hingle-collaborative-ai-literacy-2025]]
