...
Simulation sits at the core of [[experiential-learning|experiential]] and [[active-learning]] pedagogies. It provides the deliberate practice, productive failure, and [[feedback-loop|feedback loops]] that build skill and judgment. AI has transformed simulation in two ways: it powers more realistic and adaptive simulated environments, and it generates simulated learners, patients, or interlocutors that make practice scalable.
