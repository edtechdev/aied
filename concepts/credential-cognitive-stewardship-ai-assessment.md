...
**Yao (2026)** — Independent / university policy audit. arXiv preprint (cs.CY).

📄 [Full text (arXiv)](https://arxiv.org/abs/2607.19988)
...
## Related Pages
- [[assessment-validity]] — related wiki thread
- [[academic-integrity]] — related wiki thread
- [[ai-assessment-scale-reform]] — related wiki thread
- [[universities-ai-era-rethinking]] — related wiki thread
- [[genai-assessment-governance]] — related wiki thread

## Citation
**APA:** Yao, K. (2026). *What Does the Credential Still Certify? Cognitive Stewardship for AI-Mediated Education*. arXiv:2607.19988. arXiv preprint (cs.CY).
