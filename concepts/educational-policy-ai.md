...
> **Educational policy for AI** is analyzed in [[state-policy-teacher-ai]], [[regulation]], [[ai-governance-education]], and [[regulation]]: policy design choices (allow/prompt/teach) measurably shape classroom use, and governance must keep pace with capability ([[educational-policy-ai]]).
