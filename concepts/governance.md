...
- The page distinguishes detection-based governance (policing AI use) from [[design-based-research|design-based]] governance (redesigning assessment so AI use is expected and declared). Which approach does your own assessment practice lean toward, and what are the trade-offs of each?
