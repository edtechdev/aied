...
**Leinonen & Denny (2026)** — [arXiv preprint](https://arxiv.org/abs/2607.20446)
...
## Related Pages
- [[ai-detection]] — core detection task evaluated
- [[academic-integrity]] — the applied stakes of self-detection
- [[plagiarism-detection]] — adjacent detection approaches
- [[socially-fluent-ai-identity-detection]] — related AI-vs-human identity detection
- [[student-rationalization-ai-writing]] — student behavior around AI writing use

## Citation

Leinonen & Denny (2026). Distinguishing Artificial from Authentic: Evaluating LLMs for Detecting LLM-Generated Content. arXiv:2607.20446. arXiv preprint (cs.CL).
