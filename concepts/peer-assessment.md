...
Where peer assessment produces a grade, the question is whether the grade is defensible. [[usher-faraon-who-grades-best-2026|Usher and Faraon (2026)]] found peer–instructor alignment was strongest for lower-quality work (r = 0.51 in the low-quality tier) and weakened for high-quality projects, which peers tended to under-grade — plausibly reflecting reluctance to criticise strong work. ChatGPT showed the opposite pattern: better alignment on high-quality work, but inflated grades for weak submissions. Students perceived peers' grades as more consistent with the peers' own written feedback, and valued peers' relationship-aware judgement alongside ChatGPT's neutral consistency. Peer accuracy is quality-dependent and relationship-sensitive, and no single source is reliable across the whole range.
