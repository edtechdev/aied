...
- **CircuTutor (2026):** [[circututor-dc-circuit-tutoring-2026|Luo, Ma, Chen & Chen (2026)]] convert static DC-circuit problems into a state-driven tutoring workflow — [[multimodal]] problem parsing, a SPICE-compatible solver, before/after state animations, causal reasoning chains, misconception diagnosis, and adaptive follow-up exercises — and find improved conceptual learning and learning gains versus control, a concrete instance of simulation-backed, misconception-driven ITS design.
...
- [[circututor-dc-circuit-tutoring-2026]] — CircuTutor: state-driven DC-circuit tutoring (causal reasoning chain, misconception diagnosis)
