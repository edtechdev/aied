...
- [[llm-math-tutoring]] — Directly evaluates and improves math tutoring with LLMs
- [[ai-feedback-quality]] — Four-signal index provides a concrete quality metric for AI feedback
- [[reinforcement-learning-education]] — Quantifies the alignment tax of pedagogical RL
- [[benchmark-driven-edtech]] — TEI is a benchmark-validated metric for tutor quality
- [[student-ai-interaction]] — Improvement rate on pre-incorrect scenarios measures real student outcomes
- [[learning-by-chatting-genai-impact]] — Output bias toward solution-oriented artifacts vs principled knowledge parallels tutor quality measures
