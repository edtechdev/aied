...
**Raumanns et al. (2026)** — Fontys University of Applied Sciences & IT University of Copenhagen. arXiv preprint (cs.CY).

📄 [Full text (arXiv)](https://arxiv.org/abs/2607.20149)
...
## Related Pages
- [[ai-literacy]] — related wiki thread
- [[critical-thinking-genai-scaffolding]] — related wiki thread
- [[cs-education]] — related wiki thread
- [[bias-mitigation]] — related wiki thread
- [[student-ai-interaction]] — related wiki thread

## Citation
**APA:** Raumanns, R., Elstner, T., Ferger-Andrews, L., Carlsen, L. M., Potthast, M., & Schouten, G. (2026). *Data Annotations as Pedagogical Hints: From Subjective Labels to Critical Thinking*. arXiv:2607.20149. arXiv preprint (cs.CY).
