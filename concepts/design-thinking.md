...
confidence: low
---
> **Design Thinking** — a key concept in [[ai-education|AI in education]] research. Explored across 1 articles in this wiki.

Research themes include:
- Investigates adversarial [[agentic-ai|AI design agents]] that enact constructive conflict to prompt reconsideration in novice designers. Between-subjects experiment (N=48) comparing adversarial vs. cooperative AI agent roles. Adversarial agent condition produced si
