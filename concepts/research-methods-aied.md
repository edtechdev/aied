...
methods: [ai-ed-evaluation, benchmark, rct]
---
...
- **Limitations:** consensus reflects expert judgment, not empirical evidence — it establishes agreement, not effect; results depend on panel [[writing-education|composition]] and the (subjective) consensus threshold; can be slow across multiple rounds; a single panel's judgment may not generalize.
