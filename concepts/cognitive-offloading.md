...
- **Student self-perception of offloading risk:** [[student-perceptions-ai-study-tools-2026|Oladosu (2026)]] exploratory survey (N=26) finds most students report AI makes assignment completion faster (80.7% agree) and improves understanding (92.3%), yet the same respondents independently voice concerns about overreliance, reduced critical thinking, reduced independent effort, and inaccurate information. The pattern — productivity gains co-occurring with self-reported offloading concerns — illustrates how students can perceive the [[cognitive-offloading-speedup-illusion|speedup]] benefits of offloading while recognizing its learning risks, converging with the speedup-illusion and critical-thinking-paradox threads above.
