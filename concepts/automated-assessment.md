...
Automated grading is one of the most mature and widely-deployed [[ai-education|AI in education]] applications — [[ai-technologies|AI systems]] that evaluate student work, from multiple-choice scoring to essay assessment and code review. Its grading modalities include:
...
- **Psychometric calibration of LLMs:** [[psychometrically-aware-ai|Psychometrically aware AI]] advances the standard of aligning [[llm]] scoring with measurement theory, with calibration as a core requirement alongside [[item-response-theory]] alignment.
