...
**Wu, Zhou, Ma, Chen, Gao, Lin, Wu, Gou, Liu, Lau & Dou (2026)** — CUHK; Southern Medical University; Peking University; Tencent. arXiv preprint (cs.CL).
...
## Related Pages
- [[intelligent-tutoring]] — decision-centered learning trajectories
- [[multimodal-ai-tutoring]] — multimodal orchestration of learning content
- [[engagement-metrics]] — learner-perceived engagement outcomes
- [[generative-ai]] — LLM-driven scenario and narrative generation
- [[llm-tts-dialogue-lesson-generation]] — related LLM-authored interactive lesson content
