...
- **Choose discipline-appropriate AI.** STEM spans math (tutoring), physics ([[socratic-method|Socratic dialogue]], [[simulation]]), CS (code generation, review), and engineering (design, workforce) — select tools matched to each subfield's signature [[pedagogy]] rather than assuming one general chatbot fits all.
...
- [[ai-supported-instruction-stem-meta-analysis-2026]] — Pooled effect of AI-supported STEM instruction across 35 studies, with the largest gains in high school (Doğan et al. 2026)
