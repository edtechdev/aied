...
📄 [Full text (arXiv)](https://arxiv.org/abs/2605.21962)
...
## Related Pages
- [[programming-its]] — Frames serious games as an ITS application domain with distinct adaptivity requirements
- [[multimodal-affective-its-presentation]] — Complements multimodal ITS architectures with game-based training contexts
