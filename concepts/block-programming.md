...
Block-based programming is closely related to [[programming-education]], [[computational-thinking]], and [[cs-education]]. In the AI era, block-based environments are increasingly combined with conversational AI agents and [[embodied-learning|embodied robot execution]] to help learners connect abstract program logic to meaningful, observable outcomes.
