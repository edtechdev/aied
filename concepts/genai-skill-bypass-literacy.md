...
**Oliveira, English, Ryan, Misiejuk, dal Ponte, Lopez-Pernas & Saqr (2026)** — arXiv preprint.

📄 [Full text (arXiv)](https://arxiv.org/abs/2607.05411)
...
## Related Pages
- [[ai-literacy]] — Understanding and evaluating AI.
- [[higher-ed]] — Postsecondary education context.
- [[over-reliance]] — Risks of depending on AI.
- [[generative-ai]] — LLM-based educational tools.
- [[faculty-development]] — Teacher/professional training.

## Citation
**APA:** Oliveira, English, Ryan, Misiejuk, dal Ponte, Lopez-Pernas & Saqr (2026). *The GenAI Skill Bypass: Mapping Divergent Pathways of University Students and Staff AI Literacy*. arXiv:2607.05411. arXiv preprint.
