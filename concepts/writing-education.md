...
The classroom rules [[teacher-education|preservice teachers]] write expose a parallel product–process split in how writing itself is understood. [[nash-preservice-teachers-classroom-ai-policies-2026|Nash and Burriss (2026)]] find that their participants located the work of thinking in text production and disallowed AI composition, even while permitting AI for the ideation and revision tasks they themselves described as thinking — reading writing as intellectual performance assessment rather than as the layered thinking process the offloading research describes. Where [[layer-sensitive-cognitive-offloading-writing-2026|Chen (2026)]] asks which cognitive layer a student has delegated, these policies answer the same question by rule rather than by design, and they answer it inconsistently.
...
- **Treat policy writing as teacher education, not compliance.** Asking preservice teachers to author their own classroom AI policies surfaces their assumptions about writing more effectively than abstract discussion ([[nash-preservice-teachers-classroom-ai-policies-2026|Nash & Burriss, 2026]]); programs should help teachers deconstruct writing into brainstorming, drafting, revising and editing, and ask where thinking, learning and value actually live at each stage.
