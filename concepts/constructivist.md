...
- **Lineage into modern [[edtech-platform|edtech]].** Logo's emphasis on creative, hands-on construction underpins [[game-based-learning]], [[project-based-learning]], [[educational-robotics|robotics]] (LEGO Mindstorms, [[cs-education|Scratch]], programmable bricks), and the broader maker movement.
...
2. **Use the [[icap-framework|ICAP]] lens.** ICAP classifies engagement into constructive, interactive, active, and passive modes — use it to evaluate whether AI interactions actually elicit constructive and interactive modes rather than passive consumption. Designers should favor the deeper (constructive and interactive) modes where the learning goal warrants.([[hingle-collaborative-ai-literacy-2025]])
