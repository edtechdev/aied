...
- **Question and content generation:** beyond CODE-GEN, HITL guides question generation for assessment and [[scaffolding]] ([[code-gen]], [[llm-difficulty-calibration-programming-exams-2026]]). [[lee-learner-question-types-ai-education-2026|Lee, Atif & Kang (2026)]] apply the same principle to the receiving end of questions: doctoral-level raters authored the operational definitions for three constructivist question roles, labelled independently to Fleiss' kappa 0.83 after resolving discrepancies, and reviewed the augmented items and misclassified examples that supplied the study's three error patterns (role overlap, ambiguous learner intent, technical phrasing misread as cognitive depth). Because facilitator and co-learner intent stayed confusable across all four transformers, the authors conclude that a hybrid configuration — AI performs initial categorisation, educators validate outputs — is the defensible one, since full automation risks propagating misleading [[feedback]].
