...
**APA:** Jingzhe Lin, Hengbin Yu, Yongdan Zeng, Fangwei Zhong (2026). ['EduMirror: Modeling Educational Social Dynamics with Value-driven Multi-agent Simulation'](https://arxiv.org/abs/2606.07948).
...
**APA:** Jingzhe Lin, Hengbin Yu, Yongdan Zeng, Fangwei Zhong (2026). *EduMirror: Modeling Educational Social Dynamics with Value-driven Multi-agent Simulation*. arXiv:2606.07948. ICML 2026 — cs.MA, cs.CY.
