---
title: Faculty Development and GenAI
created: 2026-05-07
updated: 2026-05-07
type: concept
...
This scaling shows that faculty development is not enough — the playbook's Stage 1–3 must be complemented by **module, programme, and institutional infrastructure**.
...
- Ethical/responsible use (integrity, bias, environmental impact)
...
Non-linear cycle of rapid iteration — agility over multi-year planning.

## Relationship to AI-in-Ed Research

The playbook's findings directly connect to research threads in the wiki:

- **Student over-reliance** → [[ai-tutor-safety-harms|SafeTutors]] cognitive-offloading harms
- **Critical thinking degradation** → [[metacognition|metacognitive suppression]]
...
## Sources
- Lewis Miller, C., Barth, D., Gay, K., Scherer, F. & Herron, J. (2025). *Faculty Development and GenAI Playbook: Evidence-based Best Practices*. Every Learner Everywhere / OLC. [PDF](https://www.everylearnereverywhere.org/wp-content/uploads/Faculty-Development-and-GenAI-Playbook.pdf)
