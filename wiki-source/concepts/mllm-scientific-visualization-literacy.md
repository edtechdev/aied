...
**Patrick Phuoc Do, Chau M. Ta, Chaoli Wang (2026)** — arXiv preprint. arXiv:2607.15176.

📄 [Full text (arXiv)](https://arxiv.org/abs/2607.15176)
...
## Related Pages
- [[ai-literacy]] — benchmarks MLLMs on scientific visualization literacy vs 485 humans
- [[stem-education]] — implications for AI support in interpreting scientific figures
- [[benchmark]] — reusable SciVis-literacy benchmark methodology (49 items, 18 viz)
- [[generative-ai]] — evaluates multimodal generative-AI systems on literacy tasks
- [[higher-ed]] — undergraduate science-literacy assessment context
- [[formative-assessment]] — assessment instrument for visualization competence

## Citation
**APA:** Patrick Phuoc Do, Chau M. Ta, Chaoli Wang (2026). *Benchmarking Multimodal Large Language Models for Scientific Visualization Literacy*. arXiv:2607.15176.
