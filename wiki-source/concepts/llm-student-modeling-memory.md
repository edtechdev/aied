...
## Sources
- Nie et al. (2026). *PersonaVLM: Long-Term Personalized Multimodal LLMs*. arXiv:2604.13074 (accepted at CVPR 2026). [PDF](https://arxiv.org/pdf/2604.13074)


- [[retrieval-augmented-tutoring-algorithm-kite]] — KITE's intent-aware response strategy and student adaptation
- [[llm-student-simulation-misconception-faithfulness]] — Belief-aware student modeling vs. static output matching
## Related Pages
