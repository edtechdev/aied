...
**Harrington et al. (2026)** — University of Toronto Scarborough & international partners. arXiv preprint (cs.CY).

📄 [Full text (arXiv)](https://arxiv.org/abs/2607.19699)
...
## Related Pages
- [[academic-integrity]] — related wiki thread
- [[student-perception-ai-use-collaboration]] — related wiki thread
- [[genai-policies-higher-ed-computing]] — related wiki thread
- [[equity]] — related wiki thread
- [[genai-impact-chinese-students-hss]] — related wiki thread

## Citation
**APA:** Harrington, B., Zlotnikova, I., Nadarajan, G., & Ekundayo, S. (2026). *Did Alice Do Wrong? Cross-Cultural Differences in Student Perceptions of Generative AI Use in University Computing Education*. arXiv:2607.19699. arXiv preprint (cs.CY).
