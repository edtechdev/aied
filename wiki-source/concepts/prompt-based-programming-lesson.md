...
**Tran, Marwan & Price (2026)** — cs.CY
📄 [Full text (arXiv)](https://arxiv.org/abs/2606.30547)
...
## Citation
**APA:** Keith Tran, Samiha Marwan, Thomas Price (2026). *Teaching Prompt-Based Programming with LLMs: A 45-Minute Lesson with Guided Practice for End-User Programmers*. arXiv:2606.30547. cs.CY.
