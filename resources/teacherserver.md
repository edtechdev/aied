...
## Notes
The project claims a locally installed AI server for speed and that data is processed locally and never stored, plus Department of Education guideline compliance, but the site names no individual author or organisation behind it, so those claims are worth verifying before use with student work. Access requires registration, and there is a companion paid-later platform for building your own tools.
