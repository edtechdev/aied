...
**Conceptualisation.** AI literacy among language teachers is most often modelled as a set of competencies spanning technological, [[pedagogy|pedagogical]] and (less so) critical-[[ethics|ethical]] dimensions. Domain-specific literacy — how AI reshapes language teaching's subject matter — is comparatively thin, echoing the knowledge base's broader finding that [[ai-literacy]] frameworks routinely under-specify disciplinary content.
