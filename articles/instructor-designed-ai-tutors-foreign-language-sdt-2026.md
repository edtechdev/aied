...
1. **Instructor-designed AI tutors** (customized GPTs scoped to course objectives, learner proficiency, and a curated knowledge base) can structure AI-mediated practice more consistently than unstructured general-purpose chatbot use.
...
3. **Affective safety is a product of instructional design**, not of the technology itself — nonjudgmental, immediately responsive interaction supports relatedness for error-anxious learners.
