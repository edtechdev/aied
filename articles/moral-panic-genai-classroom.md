...
- The authors interpret the *stable central tendency but elevated variability* during GenAI-available as evidence that **some students unethically used GenAI** to boost knowledge scores (heterogeneous use masked underlying learning differences). Moving knowledge quizzes to paper removed that opportunity and exposed that integrated-cohort students were **less prepared** — plausibly from over-reliance on GenAI to summarise content.
