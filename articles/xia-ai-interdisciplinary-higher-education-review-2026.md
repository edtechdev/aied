...
- **Six forms of interdisciplinary education were identified:** [[stem-education|STEM]] dominated (n = 26), followed by cross-disciplinary student backgrounds (n = 14), non-STEM fields (n = 10), cross-disciplinary learning content (n = 10), inter-STEM (n = 8) and STEAM (n = 2), spanning domains from engineering and [[biology-education|biology]] to journalism, design and theatre.
- **Three research focuses structured the literature:** AI-empowered [[curriculum-design|curriculum]] and teaching transformation was the largest (n = 25), followed by AI-based learning analysis and educational evaluation (n = 20) and AI tool and system development (n = 14).
...
- **Stakeholder impacts spanned cognition, behaviour and emotion:** Students were the most-studied group (n = 57; cognition 47, behaviour 43, affect 14), teachers next (n = 26; behaviour 24, cognition 18, affect 7) and staff least (n = 4), revealing a strong learner-centric bias in the field.
- **Three challenges limit the field:** Interdisciplinary design often lacks depth and contextual grounding (short interventions, small samples); AI integration brings technological, ethical and learner-related risks (accuracy, bias, [[privacy]], [[cognitive-offloading|overreliance]] and immature assessment instruments); and human-centred curricular models face scalability and generalisability constraints.
...
- **Equity and governance gaps persist:** Most included studies came from technologically advanced regions with limited representation of under-resourced contexts, [[prompt-engineering|prompting]] calls for institutional policies on [[ethics]], bias, transparency, student data privacy and equitable [[digital-divide|access]] to AI tools.
...
- **Hybrid quality assessment:** Because the corpus mixed [[quantitative-research|quantitative]], [[qualitative-research|qualitative]] and [[mixed-methods-research|mixed methods]] studies, a hybrid framework applied six criteria scored 0–3 each; total scores ranged from 8 to 15 and no study was excluded on quality grounds.
...
- **A descriptive framework rather than a meta-analysis:** The review maps the field across six interdisciplinary forms, three research focuses and four AI roles (evaluator, agent, monitor, assistant), then synthesises these into the interdisciplinary human-AI interactive learning model.
...
- **Build institutional governance first:** [[governance|Institutions]] should establish clear policies on AI ethics, bias, transparency and student data [[privacy]] before scaling AI across programmes, ensuring integration is institutionally guided rather than technology-driven.
...
- **Align AI use with sustainability and citizenship goals:** Programmes should connect AI-supported interdisciplinary work to [[sustainability]] and global citizenship, embedding ethical reflection alongside technical training.
- **Strengthen evaluation rigour:** Future studies should adopt longer interventions, larger samples and validated assessment instruments, and report effect sizes to counter the field's reliance on short, context-specific and hard-to-generalise designs.
