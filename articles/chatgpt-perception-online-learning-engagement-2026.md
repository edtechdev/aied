...
- **Perception of ChatGPT** (adapted from Chan & Hu, 2023): three subscales — Knowledge of Generative AI Technology (KGAT, 6 items), Willingness to Use Generative AI [[ai-technologies|Technologies]] (WUGAT, 8 items), and Concerns About Generative AI Technologies (CGAT, 4 items); Cronbach's α = 0.711.
...
Mehrvarz, M., Salimi, G., Abdoli, S., & McLaren, B.M. (2025). [*How does students' perception of ChatGPT shape online learning engagement and performance?*](https://doi.org/10.1016/j.caeai.2025.100459). *Computers and Education: Artificial Intelligence*, 9, 100459.
