...
- **Sequence scaffolds to task demands.** Since inquiry shifts from assertion/verification early on toward procedural and directive use as tasks grow more conceptually demanding, interventions should be timed to the conceptual difficulty of the material — especially for misconception-prone topics such as inheritance and polymorphism — rather than applied uniformly.
