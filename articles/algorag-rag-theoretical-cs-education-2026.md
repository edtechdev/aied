...
8. Sorting Algorithms recorded the single highest pedagogical quality score (0.8250) on only six test items, consistent with the highly standardised structure of comparison-sort lower-bound arguments.
