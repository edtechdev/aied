...
5. **Provider-directed items showed the largest gaps.** When the item stem referred explicitly to the provider, teacher-labelled feedback was rated more trustworthy (4.41 vs 3.92; b = 0.51, p < .001, partial η² = 0.22), judged to have taken more effort (5.62 vs 4.32; b = 1.34, p < .001, partial η² = 0.26) and was more likely to be relied on (b = 1.45, p < .001, partial η² = 0.37), with a small benevolence advantage (3.87 vs 3.77; b = 0.10, p < .001, partial η² = 0.01).
6. **Preference split roughly three to one.** Asked which message they would prefer to pass on to a student, 73% chose the teacher-labelled feedback and 27% the ChatGPT-labelled feedback, consistently across all three texts, t(400) = 15.55, p < .001, d = 0.78.
...
## Source aversion or accuracy judgement?
...
- [[human-ai-collaboration]] — hybrid intelligence as the constructive response to teacher scepticism
...
- [[self-report-measures]] — the measurement approach and its limits for translating ratings into behaviour
