...
3. **Identical feedback was rated less credible, less useful and less fair under the AI label.** Teacher-labelled versus AI-labelled means were 4.02 vs 3.82 on message credibility, 5.99 vs 5.55 on [[technology-acceptance-model|perceived usefulness]] and 5.98 vs 5.51 on perceived fairness. The linear mixed models estimated b = 0.21, p < .001, partial η² = 0.04 for credibility; b = 0.47, p < .001, partial η² = 0.07 for usefulness; and b = 0.48, p < .001, partial η² = 0.08 for fairness, with the ChatGPT label as the reference condition.
