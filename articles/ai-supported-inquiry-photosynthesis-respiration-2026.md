...
1. A quasi-experimental pretest–posttest control group design with an embedded qualitative component was used with 48 second-year [[teacher-education|pre-service science teachers]] in Türkiye (25 control, 23 experimental), taught the same photosynthesis and respiration [[curriculum-design|curriculum]] by the same instructor.
...
5. Qualitative self-evaluation forms reported perceived gains in [[misconceptions|correcting misconceptions]], digital content creation, critical evaluation of AI outputs, collaboration, and [[student-engagement|engagement]], providing contextual but not confirmatory evidence.
