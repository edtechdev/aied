...
1. A quasi-experimental pretest–posttest control group design with an embedded qualitative component was used with 48 second-year [[teacher-education|pre-service science teachers]] in Türkiye (25 control, 23 experimental), taught the same photosynthesis and respiration curriculum by the same instructor.
