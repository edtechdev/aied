...
A striking result is the disconnect between student trust in GenAI outputs and confidence in their own skill. While 51% of users expressed negative sentiment toward the accuracy of outputs, 76% were confident in their ability to generate desired outputs. The authors interpret this "accuracy paradox" through [[technology-acceptance-model|disruptive-innovation theory]]: the inferiority of primary functionality (factual and citation accuracy, mathematical rigor) is overridden by secondary functionality such as convenience, conversational accessibility, and 24/7 availability.
