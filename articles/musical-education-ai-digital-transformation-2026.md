...
4. Education must shift toward production and [[ai-literacy|DAW and AI fluency]], while foregrounding the embodied, social dimensions of ensemble performance as the aspects most resistant to AI substitution.
5. [[equity-in-ai-education|Income support]] experiments, such as Ireland's Basic Income for the Arts pilot, show that decoupling creative income from the atomized sale of output can be economically constructive, offering a rare empirical alternative to streaming-era value collapse.
6. AI systems that are trained recursively on their own output risk "model collapse" toward low variance, amplifying the homogenization of musical style that [[learning-analytics|algorithmic curation]] already accelerates.
