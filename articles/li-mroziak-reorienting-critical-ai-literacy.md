...
**Resisting AI is a pluralist, community-rooted praxis.** The paper enumerates grassroots, community-led initiatives in intersectional and transnational contexts: planetary-justice advocates co-designing art-based campaigns against data-center expansion; gender and LGBTQ+ communities organizing around encoded cisheteronormativity; Latin American data workers building informal networks of care and collective resistance around digital labor; and decolonial practices of unlearning, co-learning, and relearning. Together these exemplify participatory, situated processes that build [[agency|collective agency]] and pluralize CAIL.
