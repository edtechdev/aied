...
- **Reality-accuracy trade-off is central.** Tightening guardrails to prevent deviation risks making the [[llm|LLM]] robotic and unrealistic; loosening them risks bias, inaccuracy, unpredictability, and inappropriate emotional dependence — a philosophical question about how much deviation from faculty control PBL can absorb.
