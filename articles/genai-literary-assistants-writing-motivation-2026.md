...
**Design and sample.** A quasi-experimental, single-group pre–post design with mixed-methods data collection was used with ninth-grade students from a [[k-12|junior high]] in northern Taiwan. From 44 recruited students, the final valid sample was 40 after excluding participants for failing to complete at least two-thirds of camp activities (N = 1), a questionnaire missing-response rate over 20% (N = 2), and a pre–post writing-score change exceeding two standard deviations (N = 1).
