...
Students experienced autonomy as self-direction and control over how, when, and what they learned — selecting strategies that fit their needs, monitoring progress, and even modifying AI suggestions rather than blindly adopting them, demonstrating volition central to SDT. They also experienced a form of relatedness: although ChatGPT is not a human partner, conversational and responsive interactions created a sense of being heard and supported that reduced isolation and prepared them for real conversations. The authors frame this as an "AI-mediated motivational ecology" in which the three basic psychological needs are partly met through [[student-ai-interaction|AI interaction]] rather than solely through instructors and peers — an extension of SDT from a purely human-centered model.
