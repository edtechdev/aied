...
- **Refined 27-item CFA model.** The initial 30-item CFA underperformed (CFI = 0.893, TLI = 0.881). Three weakly loading or conceptually ambiguous items were removed on theoretical grounds—CON2 (supporting students with [[special-education|special needs]], which overlapped with knowledge/autonomy), EVA5 ([[bias-mitigation|fairness]] in AI-based assessment, more central to ethics), and COL2 (general teamwork rather than human–AI collaboration)—and one residual covariance pair (ETH1–ETH2, privacy and ethical tool selection) was allowed. The final model reached acceptable fit (CFI = 0.919, TLI = 0.908, RMSEA = 0.058), with Knowledge, Autonomy, and Ethics retaining five items each and the other three dimensions four each.
