...
## Limitations
The review also circulates under a second title — [*Generative AI for Creative Learning in K-12 Education: Insights from a Systematic Scoping Review*](https://osf.io/preprints/psyarxiv/cb2uk_v1) — with the same authors and the same corpus of 45 studies, so this page covers both versions.
