...
2. **Verification and accountability practices.** Where GenAI contributes claims, examples or references, learners show how claims were checked, which sources were consulted, and how discrepancies or uncertainty were addressed. Inaccuracies become objects of responsibility rather than evidence of misconduct, a direct response to the probabilistic character of generative output. Sharma links these practices to designs that triangulate evidence across paired tasks to verify learning and strengthen [[assessment-validity|assessment validity]] in AI-vulnerable contexts (Roe et al. 2025), and to formative assessment research on [[self-regulated-learning|self-regulation]] (Nicol and Macfarlane-Dick 2006).
