...
- **The all-girls format was valued as a "safe" and "relaxed" space.** Girls reported they talked more, felt braver to express ideas, and preferred all-girls over mixed-gender groups; parents noted girls often "got scared" and spoke less in mixed settings, echoing a chilly climate of gendered interpersonal behaviour.
- **Practitioners enacted three key steps:** (1) *representation* at the symbolic level (female-centred promotional language and imagery, women role models to challenge stereotypes); (2) *relationship building* at the social level (ice-breakers like a Jenga Tower game, casual break-time conversation, valuing girls' funds of knowledge, an equal facilitator–girl relationship); and (3) a *responsive approach* at the individual level (adapting prompt-[[writing-education|writing]] support for younger girls who lacked English confidence, letting girls choose digital drawing).
- **Four interlinked challenges emerged in practice:** an inappropriate workshop topic (climate change — chosen by a facilitator based on personal experience, with only two of 44 images reflecting it), limited peer collaboration (girls worked mostly individually on laptops, despite collaborative intent), inaccessibility of GenAI tools (Playground lost free functions and became "pro," a cost barrier for an under-resourced nonprofit), and language barriers in prompt-writing (the tools accepted English prompts only, a design-embedded structural barrier for non-native English speakers).
- **Underlying issues were the marginalisation of girls' voices, agency, and assets.** Workshop topics, tools, and pedagogy were largely decided by practitioners from deficit-based assumptions, without girls' participation in decision-making; girls' strengths were less recognised, and power relations among girls, practitioners, and technology persisted.
...
- **Girlification is insufficient for structural change.** Superficial adjustments (girl-only grouping, women facilitators, feminine marketing) operate mainly at the symbolic level; without changes across symbolic, structural, social, and individual levels, girls' marginalisation persists.

## Implications for Practice

- **Move beyond "painting in pink" / girlification toward centring girls:** foreground girls' voices, needs, agency, and assets across planning, implementation, and evaluation, and interrogate power relations with questions such as "For whom/whose practice?" and "Based on whose values?" (Vossoughi, 2017).
