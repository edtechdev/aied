...
**Benefits and limitations.** Students reported that Gen-AI reduced preparation time, improved product quality (eloquence, grammatical correctness, coherence), accelerated learning, overcame writer's block, and built transferable academic writing skills. However, they emphasized limitations including AI "hallucination" and fabricated or outdated information, the risk of offloading important cognitive work, and the need for effortful interaction (e.g., asking AI to explain its changes) to actually learn — central considerations for the knowledge base's [[agency]] and [[writing-education]] concepts.

**[[ethics|Ethical considerations]].** Students imposed constraints even within "open" strategies (e.g., no generating or writing false information) and weighed ethical aspects of Gen-AI use in the group context. The authors caution that the findings reflect a small, AI-expert graduate sample and should be interpreted as context-specific rather than a comprehensive taxonomy, but they offer insights into more advanced patterns of Gen-AI use in collaborative writing in [[higher-ed]].

## What this means for practice

- **Instructors.** Have each group write down and share its Gen-AI strategy before drafting, because interview accounts sometimes contradicted students' own written reflections—one student denied having a group strategy while describing one in writing—so strategies are not equally visible to all members.
- **Instructors.** Give Gen-AI an explicit integration role—merging parallel, individually written sections into one coherent text—rather than leaving coordination to emerge, and attach a verification step for fabricated or outdated content.
- **Instructors.** Require effortful interrogation of AI edits, such as asking the tool to explain what it changed, so that Gen-AI's use for grammar, translation, and first drafts does not substitute for the cognitive work that builds students' [[agency]] over the text.
- **Designers.** Build shared documents into the assignment workflow: the "open," individually driven strategies in this study were coordinated through Google Docs, which made each member's AI use partly visible to the group.
- **Researchers.** Triangulate interviews with artifacts—reflections and the group writing documents—when studying Gen-AI use in groups, since the two sources diverged on whether a strategy existed at all.

## Limitations

- Ten postgraduate students (aged 23–39, M = 27.7, SD = 5.4) majoring in AI research volunteered out of 143 students invited from one scientific writing course at a single large Korean university, so the authors caution the findings may not generalize to broader student populations.
...
Korchak, A., Costley, J., & Fanguy, M. (2026). [*AI writes, we collaborate—or vice versa? Group strategies for using generative AI in collaborative writing assignments*](https://doi.org/10.1016/j.caeo.2026.100390). *Computers and Education Open*, 100390. https://doi.org/10.1016/j.caeo.2026.100390
