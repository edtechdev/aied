...
> **Synthesis:** Liu and Deris (2025) introduce and validate the construct of **AI [[feedback-literacy|feedback literacy]] (AIFL)** — students' capacity to critically engage with, evaluate, and apply AI-generated feedback — in the context of [[english-education|English as a foreign language]] (EFL) writing in [[higher-ed|higher education]]. Drawing on Carless and Boud's (2018) feedback literacy framework and [[motivation|motivational]] models ([[self-determination-theory|self-determination theory]], feedback-seeking theory, cost-value models), they developed a psychometric scale and tested it with 486 Chinese undergraduate students. Using confirmatory factor analysis, PROCESS-macro mediation modeling, and multiple regression, the authors show that AIFL significantly predicts uptake of AI-generated feedback, both directly and indirectly through motivational appraisals of perceived value and perceived cost. Behavioral [[student-engagement|engagement]] (practices) outperformed attitudinal disposition (attitudes) as a predictor of uptake, and AIFL development was driven by frequency of AI tool use rather than demographic background — raising [[equity-in-ai-education|equity concerns]] about access and opportunity in increasingly AI-mediated assessment environments.
...
- **Behavioral engagement outweighs attitudes.** In a multiple regression explaining 46% of variance in uptake (R² = 0.46), perceived value was the strongest predictor (β = 0.32), followed by AIFL-Practices (β = 0.27), while AIFL-Attitudes was non-significant (β = 0.08, p = 0.091). The authors interpret this as evidence that feedback literacy develops through [[embodied-learning|embodied]], [[situated-learning|situated]] practice rather than belief alone.
