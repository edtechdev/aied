...
**AI-Augmented Learning System framework.** The framework conceptualises GenAI not merely as an instructional tool but as a catalyst for curricular and [[pedagogy|pedagogical]] reconfiguration, giving structure to the otherwise diffuse discourse on [[generative-ai]] in [[higher-ed]]. It positions learners as more active participants — co-designers of learning within AI-integrated environments — and reframes the institution's role from running isolated experiments to governing an integrated system.
