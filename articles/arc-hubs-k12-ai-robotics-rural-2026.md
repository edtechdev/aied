...
7. Under the most favorable assumptions (level 12) the model produces 1,638 school programs (about 85% of schools) and reaches 1,829 schools (about 95%), more than ten times the natural-growth projection; even the least favorable level yields 338 programs, more than double the baseline.
