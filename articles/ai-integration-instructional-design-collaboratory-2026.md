---
title: "AI Integration as Instructional Design: Lessons from a Cross-Institutional Faculty Collaboratory in Teacher Preparation"
created: "2026-09-21T04:50:18-04:00"
updated: "2026-09-21T04:50:18-04:00"
type: article
sources: ['raw/papers/ai-integration-instructional-design-collaboratory-2026.md']
confidence: medium
published: "2026-09"
page_kind: [synthesis]
...
audience: [administrators, faculty developers, instructors, policymakers]
foundations: [ai-literacy, teacher-ai-competency, teacher-role, academic-integrity]
...
1. **Adoption has outrun institutional guidance.** In the 2026 survey wave cited here, 58% of U.S. math and science teachers reported using generative AI in teaching and 31% weekly, up from 50% and 21% in 2025, while only 11% said their district had formal guidelines and 58% had received no formal AI training.
2. **Even the best-supported teachers are on their own.** Among frequent users, 32% reported no district AI guidelines, only 18% reported established policies, and 61% had received no district-provided training.
3. **Teacher concerns focus on students, and they are rising.** The 2026 survey records creativity loss at 67%, over-reliance at 66% and academic integrity at 60%, each higher than the year before.
4. **Position AI as support for professional judgment.** Across the twelve implementations, faculty used it as a thinking partner, a critique generator or a rehearsal tool, with candidates keeping responsibility for evaluating, adapting and justifying decisions.
5. **Disciplinary analysis has to come before AI, not after.** Faculty who protected independent analysis found candidates could evaluate AI output more critically; when AI entered too early it bypassed the reasoning the course was designed to develop.
6. **Critique must be assigned, because it does not happen spontaneously.** Candidates did not audit AI outputs on their own, so requirements to compare, revise and justify generated content had to be built into the task itself.
7. **Disclosure changes how output is valued.** In the opening episode, candidates had judged feedback substantively useful and devalued it once AI authorship was revealed, with the content unchanged.
