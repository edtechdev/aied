...
2. Truth-seeking (t=-5.138, p<0.001) and CT Self-confidence (t=-3.038, p=0.003) rose significantly, while Cognitive Maturity declined (t=2.358, p=0.019) — a "de-centering" the authors attribute to multidimensional feedback challenging students' initial epistemic overestimation.
