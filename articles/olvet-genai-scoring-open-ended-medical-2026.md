...
- The authors emphasize that [[human-in-the-loop-ai|humans must remain in the loop]] to safeguard [[trust-calibration|validity, reliability, reproducibility, and bias]] when using generative AI for [[summative-assessment|scoring]], e.g., having faculty score a subset of exams to confirm accuracy.
