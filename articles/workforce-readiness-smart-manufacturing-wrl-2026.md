...
pedagogy: [experiential-learning, mastery-learning, professional-training]
...
3. **[[human-ai-collaboration|Human-machine collaboration]]** — working effectively alongside automation and [[agentic-ai|AI agents]], including cobot safety, ergonomics, and human-in-the-loop inspection.
...
- The four cases spanned four sectors — aluminum smelting, heavy-truck manufacturing, commercial refrigeration, and defense/naval [[research-methods-aied|research]] — without change to the pillar rubric, and faculty-mentored research capstones and industry-mentored capstones yielded broadly comparable pillar profiles.
