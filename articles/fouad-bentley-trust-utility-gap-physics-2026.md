...
A mixed-methods survey of 81 introductory [[physics-education|physics]] undergraduates reveals a 50-point [[trust-calibration|trust-utility gap]]: 91% [95% CI: 83%–96%] use AI for physics coursework, but only 41% [95% CI: 30%–52%] [[trust]] AI-generated physics explanations. Thematic analysis identified eight themes; the most distinctive finding was that 40% of qualitative respondents spontaneously articulated where AI fails — visual-spatial reasoning, circuit analysis, and abstract physical reasoning — aligning with known benchmarks. Students show [[trust-calibration|domain-calibrated skepticism]] rather than uncritical adoption, and 65% prefer optional AI integration.
...
- Student [[trust-calibration|trust calibration]] tracks AI competence boundaries (consistent with Kortemeyer benchmarks)
