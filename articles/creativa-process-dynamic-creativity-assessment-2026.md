...
8. **The claim is explicitly preliminary.** The manuscript is a preprint that has not undergone [[peer-assessment|peer review]], the psychometric sample is small, and the cross-stage pilots are reported qualitatively rather than with group-level statistics.
...
Three principles organise the design: context-embeddedness, process-orientation and interactivity. Tasks sit in multimodal, authentic scenarios; scoring targets the full problem-solving trajectory; and adaptive AI scaffolding runs throughout so that unsupported and supported performance can be compared, which is how the system operationalises the Zone of Proximal Creativity.
...
- [[scaffolding]] — graduated prompting as the operationalisation of the Zone of Proximal Creativity
...
- [[learning-analytics]] — real-time capture of behavioural and process data as the measurement substrate
