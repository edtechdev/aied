...
**Improved writing experience.** ChatGPT improved the subjective writing experience — perceived ease (d = 1.04, p < .001), felt success (d = 0.69), and reduced cognitive load (d = −1.59) during use, with ease (d = 0.60) and success (d = 0.50) still higher afterward; topic understanding did not change, and perceived control was reduced during use (d = −0.56) but unchanged afterward. Students wrote on three permuted fashion-related topics (self-image in virtual avatars, AI's potential in fashion design, and VR [[embodied-learning|embodiment]]/[[virtual-and-augmented-reality|metaverse]] in the industry), drawing only on three preselected sources per topic to avoid confounding writing with [[meta-analysis-systematic-review|literature review]].
