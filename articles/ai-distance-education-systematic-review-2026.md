...
## Key Findings
- **AI-driven personalization, [[student-modeling|learner modeling]] and adaptive support** (24 studies): AI generates personalized learning pathways, constructs learner models and provides adaptive support, improving alignment between [[learning-design|instructional design]] and learner needs; effectiveness depends heavily on data quality and representativeness, with risks of over-automation that can undermine learner [[agency]].
