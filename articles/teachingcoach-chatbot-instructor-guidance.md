...
- Step labels generated by the model can be logged for analytics and [[personalized-learning|personalization]] while optionally being hidden from the visible transcript, enabling supervision of the instructional process.
...
- **Faculty developers.** Use the same three-step [[scaffolding|scaffold]] as the backbone of coaching conversations and of any AI support you deploy, since expert raters credited that supervision — not model scale — with the clarity advantage (2.62 vs. 2.01 on a 3-point scale).
