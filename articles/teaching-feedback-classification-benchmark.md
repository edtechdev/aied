...
- **Software developers.** Keep the classifier inspectable where deployment is institutional, because the [[explainable-ai|LIME-based]] audit tied predictions to the annotation guide's own terms (*evaluación*, *faltaba*, *grosero*, *pero*, *sin embargo*) on the classical arms while the prompt-bound LLM arms offered no comparable check.
