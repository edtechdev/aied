...
The qualitative data converge on a division of labor between the two [[ai-technologies|technologies]]. [[generative-ai]] did the externalisation work: generated images gave teams a concrete artifact to point at, compare and argue over, as one student described generating an image, saying "you guys look at this window, it's kind of cool", and getting the reply "yeah, it looks stupid. We would talk about it". The value was the discussion the image enabled rather than the image itself. XR did the evaluation work: entering a shared spatial model at full scale gave a clearer sense of proportion and spatial presence than screen-based representations — "it was very useful to see the actual sizes of things" — and became more valuable once a meaningful 3D artifact existed to inspect for scale, adjacency, lighting and site context.
