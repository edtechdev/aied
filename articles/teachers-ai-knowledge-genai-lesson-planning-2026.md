...
**I-TPACK coding of articulated knowledge.** Deductive [[qualitative-research|qualitative]] content analysis mapped responses onto I-TPACK domains: TK (n = 22), TPK (n = 16), TCK (n = 9), and EK (n = 3), with 9 multi-domain and 22 uncertainty responses. Residual segments were analyzed inductively into Critical GenAI Literacy categories covering professional identity, relational positioning toward AI, and epistemic authority. A second [[research-methods-aied|researcher]] reviewed ~15% of coded material for interpretive agreement (no formal Cohen's Kappa).
