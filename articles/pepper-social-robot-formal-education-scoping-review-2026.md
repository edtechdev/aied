...
- **Predominance of qualitative approaches** (61.5%) with small samples; 23.1% [[mixed-methods-research|mixed-methods]], 15.4% [[quantitative-research|quantitative]] experimental designs. No large-scale longitudinal studies identified; 61.5% of samples had fewer than 50 participants.
- **Pepper is primarily used to support tutoring, collaborative learning, and mediation in inclusive educational settings** (including pupils with [[neurodiversity|autism]] spectrum disorder, the focus of 23.1% of studies), and its operation requires **constant teacher supervision**.
