...
- The design is cross-sectional, so it cannot establish causal direction or temporal ordering among AI anxiety, emotion regulation, and academic motivation; reverse relationships remain possible.
...
Zhang, Y., Shi, Y., & Lu, J. (2026). [The relationship between AI anxiety and academic motivation among university students: The mediating role of emotion regulation and the moderating role of gender](https://doi.org/10.3389/fpsyg.2026.1918525). *Frontiers in Psychology, 17*, 1918525.
