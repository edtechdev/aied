...
2. Biases concentrate in different behaviours per domain: in mathematics the largest effects fall on step_scaffolded (up to |r| = 0.144) and actionability (up to 0.169), while in chemistry and physics corrective_tone exceeds |r| = 0.10 for all five tutors (chemistry 0.102–0.168; physics 0.129–0.294).
...
- [[llm-pedagogical-behavior-ai-tutoring-2026]] — LLM Pedagogical Behaviour in AI Tutoring
