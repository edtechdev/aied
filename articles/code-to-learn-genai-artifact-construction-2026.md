...
2. **Student as Specifier** — the student articulates the logic in natural language (equations, rules, a labeled plan) before any code is requested, externalising the mental model so the germane work happens in the student.
