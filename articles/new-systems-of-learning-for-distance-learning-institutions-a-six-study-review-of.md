...
stakeholders: [governance, technology-acceptance-model]
ethics: [privacy]
...
- Early studies (1–3) gathered student preferences for AIDA's design and identified the benefits of 24/7, context-specific support embedded within the learning environment, alongside concerns over [[ethics]], [[academic-integrity|academic integrity]], and data privacy; around 20% of students were initially highly skeptical about whether the OU should develop and use AIDA.
