...
pedagogy: [motivation, professional-training]
...
- A utility-value intervention produced no significant overall effects on pre-service teachers' knowledge acquisition or knowledge integration in an experimental field study (N = 158).
- Adding [[scaffolding|scaffolds]] to the utility-value intervention did not change outcomes.
