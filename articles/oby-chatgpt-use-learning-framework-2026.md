...
- **[[cognitive-offloading|Cognitive load]] as the mechanism:** ChatGPT can reduce *extraneous* load by structuring information and activating [[prior-knowledge|prior knowledge]], but when outputs replace engagement with interacting elements, *intrinsic* load is bypassed rather than managed. Task complexity is closely tied to element interactivity.
