...
- Posthumanism de-centers humans as the sole autonomous meaning-making agents; agency is "enacted" through intra-actions between bodies, ideas, materials, language, [[ai-technologies|technologies]], and space (drawing on Barad, Latour, Bennett, Deleuze & Guattari's assemblage and rhizomaticity).
- The framework repudiates both extremes: uncritical anthropomorphization of AI (which encourages [[cognitive-offloading|overreliance]] and a transactional view of literacy) and dismissing AI as a mere tool (which leads to punitive measures that undermine students' exploratory meaning-making).
