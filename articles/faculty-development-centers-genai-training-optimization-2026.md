...
- **Structured prompt-task training outperformed conventional GenAI faculty development.** At post-test the structured group scored higher on all seven dimensions, with the largest advantage in prompt design — an effect of roughly two standard deviations — followed by critical judgment, basic understanding, and disciplinary transfer.
