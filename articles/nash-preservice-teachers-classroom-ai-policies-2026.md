...
- **Nearly every policy permitted some AI use, but almost always on teacher terms:** 26 of the 27 policies allowed [[generative-ai|generative AI]] for at least some tasks, overwhelmingly restricted to teacher-specified tasks, times, and places; only one participant prohibited all classroom AI use, on [[ethics|ethical]] grounds tied to labor practices and copyright.
...
- **Reading was largely unexamined:** 22 of 27 policies did not mention reading at all. Of the five that did, most framed AI as a conversation partner for clarifying challenging texts; only two disallowed AI for reading, citing the [[desirable-difficulties|productive struggle]] and comprehension work that summarization could short-circuit.
...
Nash, B. L., & Burriss, S. K. (2026). [*Writing the rules for generative machines: Tensions and entanglements in preservice teachers' classroom AI policies*](https://doi.org/10.1002/rrq.70136). *Reading Research Quarterly*, 61(3), e70136.
