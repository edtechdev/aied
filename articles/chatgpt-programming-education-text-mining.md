...
The central finding is a **dual positioning**: ChatGPT is consistently framed as both a learning aid (enhancing explanation, feedback, efficiency) and a pedagogical risk (overreliance, unreliable outputs, academic integrity). This connects to [[academic-integrity]], [[cognitive-offloading|Over-Reliance]], and [[hallucination-risk]] by documenting these as dominant framings in the research literature. Notably, research is skewed toward classroom practice while systematic assessment design and institutional governance remain underexplored.
