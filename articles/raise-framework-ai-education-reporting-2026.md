...
11. **Limitations and implications are a distinct domain.** Authors are asked to move past positive outcomes to unintended consequences — [[cognitive-offloading|over-reliance]], shifting [[teacher-role|teacher roles]] — plus generalizability, constraints, and practical and policy implications, responding directly to the journal board's concern with the ethical, emotional, and socio-cultural impacts and indirect effects of [[ai-education|AI in education]].
