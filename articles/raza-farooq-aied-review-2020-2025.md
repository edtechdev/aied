...
- **Genome Layer:** The foundational elements — instructional customs, [[assessment|evaluation practices]], [[teacher-ai-competency|leadership capacity]], low-friction digital tools, and shared algorithmic schemas that underpin [[ai-education|AI in education]]. This is the answer to *what must be true before more sophisticated systems work reliably.*
...
- **Symbiotic Layer:** End-to-end implementations including [[edtech-platform|learning platforms]], smart classrooms, automation of processes, and [[generative-ai|generative AI]] copilot systems that facilitate [[teacher-role|teaching]] and learning.
...
1. **100+ peer-reviewed papers** (2020–2025) were coded with a reproducible technique/contribution/outcome scheme; the corpus skews toward [[higher-ed|higher education]] and the Global North, limiting generalizability.
