...
This paper introduces a pipeline that maps student questions directed at a [[conversational-ai|conversational AI]] [[teacher-role|teaching]] assistant to [[curriculum-design|curriculum]] topics using a few-shot text classifier, grounded in a GPT-4-extracted prerequisite [[knowledge-graph|knowledge graph]]. Evaluated on 1,340 question events from 164 graduate students in an AI course, the classifier achieved 80.0% accuracy across 43 labels (42 topics + abstention). Topic-level question volume correlated significantly with student self-reported difficulty (Spearman's ρ = 0.491, p = 0.008), demonstrating that conversational [[student-ai-interaction|AI interaction]] logs carry actionable signals about topic-level knowledge gaps. The work bridges [[student-modeling]] and [[learning-analytics]] by repurposing existing AI TA logs as diagnostic tools for instructors.},
