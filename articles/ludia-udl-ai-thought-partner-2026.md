...
3. LUDIA is engineered as a thought partner rather than a solution engine, structured around the Four T's (Tell, Tinker, Tweak, Transfer), and guards against [[cognitive-offloading|over-reliance]] by framing every response as an option to weigh and by pointing back to CAST's published Guidelines.
