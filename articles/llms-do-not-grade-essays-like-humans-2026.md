...
4. **[[privacy|Privacy]] and consent are essential.** Processing student essays via commercial APIs may violate FERPA/GDPR; student data could be used for model training or later flagged as AI-generated by [[plagiarism-detection|plagiarism detectors]]. [[open-source|Open-source]] models running locally are a more [[privacy]]-preserving option. Students should be informed when LLMs are involved in evaluating their work.
