...
confidence: high
audience: [instructors, educators, administrators]
---
...
- **Two interpretive response patterns emerge:** a *transparent tendency* (disclosing to teachers, checking with [[teacher-role|instructors]], treating instructor interaction as an external regulatory checkpoint) and an *anxious-concealing tendency* (frequent AI use for substantive tasks paired with elevated worry and withdrawal from formal feedback — consistent with maladaptive [[regulation]]).
