...
3. **Sibling construct and boundary.** A sibling construct, the Absent Cognitive Baseline, marks the case where no verdict can form; frameworks from [[philosophy-of-ai-in-education|epistemic akrasia]] to [[academic-integrity|academic dishonesty]] each lack one element of MDC. GenAI's part is amplification, not invention.
...
Jia, Y. (2026). [*Metacognitively discordant completion and the aware pass-through of non-understanding in generative AI learning*](https://osf.io/preprints/edarxiv/wzjxf_v1/). EdArXiv preprint.
