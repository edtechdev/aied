...
- **Four AI modality categories.** The included studies spanned (1) [[generative-ai|generative AI]]/LLMs (n=7, e.g., ChatGPT-driven virtual patients), (2) AI-driven virtual patients/mannequins (n=5), (3) AI-enhanced virtual/[[virtual-and-augmented-reality|mixed reality]] (n=5), and (4) [[conversational-ai|chatbots]] (n=2) — a heterogeneous field that precluded [[quantitative-research|quantitative]] meta-analysis.
