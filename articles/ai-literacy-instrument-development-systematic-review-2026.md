...
10. **The forward agenda is consolidation, not proliferation.** The authors call for performance-based and process-oriented assessment, [[learning-analytics|learning analytics]] and behavioural-trace measurement of [[prompt-engineering|prompting]] and verification, longitudinal designs tracking how AI literacy develops, criterion-referenced [[benchmark|benchmarks]], and systematic measurement-invariance testing across populations and languages.
