...
## Key Findings
1. **Teacher education is the linchpin.** The most consensus-heavy finding is that effective and responsible AI integration depends on [[teacher-role|teachers']] pedagogical and technological preparedness. AI-focused [[faculty-development|professional development]] is positively associated with instructional quality (cognitive activation, classroom management, [[personalized-learning|personalised learning]]), and frameworks such as Intelligent-[[tpack]] and AI-TPACK predict teachers' readiness, with AI literacy, algorithmic ethics, and digital competence as core ingredients.
2. **Structured, interdisciplinary curricula are needed.** Research supports frameworks like AI4K12 and the Five Big Ideas in AI. [[ai-education|AI education]] is shifting from narrow technical content toward competency-based models that incorporate [[critical-thinking|critical thinking]], digital citizenship, [[creativity]], problem solving, and ethical reflection — with emerging competencies like [[prompt-engineering|prompt engineering]] gaining recognition.
...
4. **Generative AI offers opportunities and raises tensions.** GenAI tools (ChatGPT, Gemini, Copilot) support retrieval, content generation, personalised tutoring, and instructional planning, but raise concerns about [[cognitive-offloading|cognitive offloading]], content reliability, pedagogical oversight, and technological dependency.
5. **Equity and governance are cross-cutting.** Disparities in access, connectivity, and training risk reinforcing [[equity-in-ai-education|educational inequalities]]. The review calls for governance models, [[governance|institutional]] policies, and [[regulation|regulatory]] frameworks ensuring transparency, accountability, [[human-in-the-loop-ai|human oversight]], data protection, and [[academic-integrity|academic integrity]].

## Pre-university AI education as a distinct focus
This review consolidates the growing evidence that AI education in primary and secondary settings is distinct from [[higher-ed|higher education]]. It centres on teacher preparation, [[curriculum-design|curriculum design]], and the age-appropriate development of [[ai-literacy|AI literacy]] and ethical competencies — aligning with the wiki's [[k-12|K-12 AI education]] coverage. Notably, the review is framed by Sustainable Development Goal 4 (SDG 4) and Education for Sustainable Development (ESD), situating equitable, resilient, and sustainable educational systems as the goal of responsible AI integration. (Note: this framing draws on SDG 4 but the review's substance is K-12 AI education rather than AI's environmental footprint.)

## Research gaps
- **Scarcity of longitudinal studies** on the sustained effects of AI on [[learning-gains|learning outcomes]], cognitive autonomy, and socio-emotional development.
...
## Implications
1. **Invest in teacher education** that pairs AI literacy and algorithmic ethics with [[motivation|motivational]]/institutional factors ([[self-efficacy]], perceived usefulness, organisational support).
