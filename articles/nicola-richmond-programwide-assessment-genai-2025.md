...
- **Theme 2 — Assessment must change:** Both groups agreed [[assessment]] must change to (a) assure student learning (verifying graduates achieve promised learning outcomes) and (b) prepare students for a GenAI world of work. Most opposed banning GenAI, and participants emphasized assessing differently — building GenAI use into the [[curriculum-design|curriculum]], designing tasks that minimize unhelpful GenAI use, and requiring critical evaluation of AI output rather than passive consumption.
