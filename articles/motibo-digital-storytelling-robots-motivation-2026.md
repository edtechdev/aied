...
- **Instructors.** Adopt robot-assisted storytelling where the target is behavioral and cognitive engagement: the MotiBo group improved 27.06% and 30.00% on those scales (both p < .05), while intrinsic motivation rose 20.21% without reaching significance (p = .07).
- **Instructors.** Let children choose the storytelling language (Cantonese, Mandarin, or English) so they create in a preferred language rather than translating.
- **Instructors.** Run the format as short daily sessions — one five-picture story per day, about 20 minutes, across five days — with bounded attempts (three tries of 10 seconds each) to keep pacing predictable.
