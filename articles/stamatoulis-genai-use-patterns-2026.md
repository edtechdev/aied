...
- **Key variables:** Evaluative integration (EI, use to support understanding), low-verification uptake (LVU, shortcut use), academic self-efficacy (ASE), [[learning-gains|academic performance]]; frequency included for comparison.
