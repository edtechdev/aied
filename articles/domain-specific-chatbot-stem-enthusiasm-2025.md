...
5. Emotional responses were directionally favourable but non-significant: positive-activating emotions averaged M = 2.37 (SD = 1.03) in the experimental group versus M = 2.10 (SD = 0.96) in the control group (p = 0.053), and negative-deactivating emotions averaged M = 2.45 (SD = 1.15) versus M = 2.61 (SD = 1.15) (p = 0.265).
...
15. The authors summarise the asymmetry directly: ADA proved more effective at enhancing motivational engagement than at producing immediate performance gains, attributing this to the single-lesson exposure, the dual-task demands of using a chatbot while working with paper materials, and the limited sample.
