...
- **Sample:** 821 health sciences students (Physical Therapy, Pharmacy Services, Medical Secretarial/Documentation, Nursing, Speech & Language Therapy, Midwifery, Health Management) from Turkish universities; 82.5% female, 59.6% undergraduates.
- **Design:** Cross-sectional online survey (distributed by class representatives via WhatsApp).
- **Measures/analysis:** Artificial Intelligence Anxiety Scale and Job Search Anxiety Scale; Pearson correlation and multiple linear regression (SPSS v26).

## Key Findings

- **AI anxiety predicts job search anxiety.** Moderate positive correlation (r = 0.233, p < 0.001); AI anxiety remained a significant predictor (β = 0.234, p < 0.001) even controlling for socio-demographics.
...
Dağ, E., Nal, M., Topuz, İ., Kılınç, H., Demir, Y., & Bektaş, G. (2026). [*Artificial intelligence perceptions and career anxiety among health sciences students*](https://doi.org/10.1038/s41598-026-42030-z). *Scientific Reports*, 16, 42030.
