...
9. Robot type a performs a non-interactive demonstration of generic social patterns, a pre-programmed automated theater of emotions shown to a group and then discussed, illustrating generalisable dynamics such as escalation or misunderstanding.
...
11. Robot type c is a spoken-language interactive partner that shows empathic behavior and memorises interactions with single students, creating a one-to-one setting that can reduce pupils’ fear of sharing secrets with real people.
