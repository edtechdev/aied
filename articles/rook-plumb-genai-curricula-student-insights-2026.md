...
- **Priority area 1: Understanding and optimising GenAI functionality.** Students wanted a deeper grasp of how GenAI systems work, effective [[prompt-engineering|prompting]] ("how to prompt AI … to get a better response," P53), the technical foundations of [[generative-ai|generative AI]] (architectures, algorithms, training data), and how to evaluate the accuracy and "truthfulness" of GenAI outputs.
