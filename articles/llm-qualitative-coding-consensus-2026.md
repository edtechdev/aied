...
methods: [qualitative-research, research-methods-aied, benchmark]
---
...
- **Researchers.** Report the rate of "Undecidable" labels and surviving conflicts as process indicators, not as noise: undecidable cases flagged before the debate predicted larger accuracy gains (t = 3.274), whereas undecidable cases that survived it predicted smaller gains (t = -14.476) — and surface controversy volume as a predictor of discussion-prompted quality rather than a defect, deliberately decoupling "the agents agreed" from "the coding is good". Make discussion style tunable: a debate mode that injects structured opposition for ambiguous data, a strict mode for routine labeling.
