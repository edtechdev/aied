...
pedagogy: [misconceptions, refutation-text, student-ai-interaction]
...
- **Refutation texts still work.** Textbook-style refutation remained superior to control at all time points — confirming the effectiveness of the [[refutation-text|refutation text]] technique even when outshone on immediacy by personalized dialogue.

## What this means for practice

- **Instructors.** Reach for [[conversational-ai|personalized AI dialogue]] when the goal is immediate misconception correction: it produced significantly larger immediate belief reductions than both the textbook refutation and the neutral AI dialogue control.
...
- **Designers.** Keep the [[refutation-text|refutation text]] in the toolkit — it beat the neutral control at every time point — and choose dialogue where engagement and confidence matter, since both AI conditions generated significantly higher engagement and confidence than reading did.
