...
- **[[medical-education|Clinical education]] resists the tools on [[pedagogy|pedagogical]] grounds.** Reporting the position taken by Karr and Schultz, they argue that generative AI is not compatible with what clinical legal education is trying to achieve and should therefore not be used with students there: tools designed to mimic human responses do not develop original thought, understanding, or the client-interaction and [[ethics|ethical]] decision-making skills clinics exist to build.
