...
- **Generative Learning** asks students to actively generate information and make connections between new and existing knowledge; this active participation promotes deeper understanding, long-term retention, and critical thinking and problem-solving abilities, with the "generation" process being where learners make sense of material rather than passively receiving it.
- The authors propose **eight pedagogical roles** for GenAI: learning strategy/study buddy, collaborative thinking tool, possibility engine, Socratic opponent, personal tutor, exploratory research engine, motivator, and dynamic assessor.
...
1. **Prime the learning task** — teacher-initiated; activates prior knowledge and curiosity through prompting questions, AI-generated visuals, and analogies (e.g., "What do you already know about ecosystems?").
...
3. **Explain with AI** — learner-driven; students verbalize understanding in their own words with AI feedback (e.g., "Great start! Can you clarify what you mean by energy transfer?").
...
5. **Reflect and Transfer** — learner-driven; strengthens metacognition and transfer of learning beyond the activity.
