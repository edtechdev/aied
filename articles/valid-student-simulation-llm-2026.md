...
5. Open challenges remain — [[privacy]]-constrained [[benchmark|data]], non-verifiable outcomes under open-ended interaction, and the absence of shared, goal-conditioned benchmarks — alongside [[ethics|ethical]] risks such as negative training transfer in [[teacher-education]].
...
- **E3 – Misconception-structured:** an explicit, stable model of [[misconceptions]], strategies, or partial procedures causally determines behavior.
