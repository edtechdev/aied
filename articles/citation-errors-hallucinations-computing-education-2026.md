...
The practical implication is that automated detection is bounded by the quality of the metadata it treats as ground truth. The authors give the example of the author "C. I. Chesñevar" appearing in the XML metadata as "C. I. Ches nevar", a special-character artifact; superficial checks will flag such cases and miss subtler hybrids at the same time.
