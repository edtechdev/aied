...
The essay's starting point is a conceptual gap in how education discusses generative AI. [[sociocultural-learning|Sociocultural theory]] has long distinguished mediational means (language, writing, technologies) from social interaction (participation with [[teacher-role|teachers]], peers, communities). Two dominant framings of GenAI are each insufficient:
