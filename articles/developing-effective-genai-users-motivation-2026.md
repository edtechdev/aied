...
8. **Help-seeking skill is teachable, and that matters.** Students given metacognitive feedback on their help-seeking improved those skills, and the improvements carried into new material a month after the support was withdrawn (Roll et al., 2011). A proactive resource-planning prompt also improved undergraduates' [[learning-gains|academic performance]] before GenAI existed (Chen et al., 2017).
