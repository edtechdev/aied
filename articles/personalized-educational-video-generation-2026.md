...
2. Retrieval is deliberately optimised for NCERT structure: page headers such as "SCIENCE 8", keyword boxes and summary sections such as "WHAT YOU HAVE LEARNT" are stripped by regular-expression cleaning before chunking, which the authors state reduces embedding noise and improves retrieval relevance.
...
| Narration | Google TTS with Google Translate | Synthesise timed, multilingual voiceover |
