...
page_kind: [framework]
systems: [educational-policy-ai, lifelong-learning, professional-training]
---
...
6. **Five vulnerability factors.** Task substitutability, [[regulation|regulatory]] intensity, safety criticality, professional-association strength, and work modularization determine an occupation's commons vulnerability — with software engineering, financial analysis, and legal [[research-methods-aied|research]] highest, and [[medical-education|medicine]]/engineering slower due to regulatory and safety counterpressures.
