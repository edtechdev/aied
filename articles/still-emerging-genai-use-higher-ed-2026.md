...
- **Frame GAI challenges relationally, not as a technical fix.** Echoing Bearman and Ajjawi, the authors argue that [[pedagogy]] for an AI-mediated world means learning to work with opaque, partial and ambiguous situations, rather than treating the "assessment panic" as a problem solved by learning-design tweaks or more [[ai-literacy|AI literacy]] training.
