...
> **Synthesis:** This conceptual framework paper integrates [[inquiry-based-learning|inquiry-based learning]] with [[generative-ai|AI]] to solve IBL's scalability problem. It positions AI as a [[scaffolding]] layer that transitions "from an output generator to a [[metacognition|metacognitive]] coach," mapping AI interactions onto IBL's stages (orientation, conceptualization, investigation, conclusion, discussion). The framework's sustainability depends on shifting assessment from content mastery to measurable complex-thinking skills — with implications for teacher training and technological governance.
...
Doyle, L. B., & Swisher, J. L. (2026). [*Scaling complex thinking: a conceptual framework for AI-supported inquiry-based learning*](https://doi.org/10.58297/edu.2026.3.3.e183). *Educational Point*, 3(3), e183.
