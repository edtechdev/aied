...
**Complementary role.** GPT-based AES is best framed not as a wholesale substitute for human judgment in [[language-learning]] and [[writing-education]] assessment but as a calibrated scoring agent and consistency stabilizer that dampens rater variability — while guarding against residual bias and promoting fairness.
