...
1. **Knowledge transmission still dominates designed courses.** Across all 29,064 TLAs analyzed, Acquisition was the single largest learning type (above 20% of activities), followed by Practice, Discussion and [[assessment]] (each between 15% and 20%), with Investigation and Production last (around 10% each).
...
3. **Intended outcomes themselves cluster low.** The distribution of learning outcome levels was positively skewed, with most TLAs attached to levels 3 (Applying) and 2 (Understanding), followed by 4 (Analyzing) — a pattern the authors note also appears in earlier work on [[higher-ed]].
...
The dataset behind all subsequent analyses is itself a finding about scale. The BDP tool held 2,340 course designs; after requiring owner consent for anonymized research use, at least two learning outcomes, and at least ten TLAs, the analytic sample was 554 courses containing 29,064 TLAs. The filter was deliberate — the tool is free to use and open to anyone, so partially completed or test designs would have blurred the descriptive statistics, and the consent criterion was imposed to meet [[ethics|ethical]] standards. The authors note that the tool has been used by more than 3,000 educators to design more than 3,000 courses, and that the sample spans primary, secondary, higher and [[adult-learning|adult education]], formal and non-formal learning, and both institutions and companies, although they presume most designs come from [[higher-ed]].
