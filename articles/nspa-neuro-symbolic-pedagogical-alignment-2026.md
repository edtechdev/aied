...
**Ecological validity.** NSPA metrics show a statistically significant Pearson correlation (ρ = 0.10) with value-added models of teacher effectiveness, showing automated, equity-aware discourse analysis can serve as a rigorous proxy for learning outcomes — an advance for [[ai-ed-evaluation]] of classroom teaching.
