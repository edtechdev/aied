...
- Current [[intelligent-tutoring|LLM tutors]] cannot resolve the "assistance dilemma" without ITS-grounded diagnostic mechanisms.
- Effective [[intelligent-tutoring|LLM tutoring]] in structured reasoning domains requires hybrid architectures delegating diagnostic classification to [[knowledge-graph|KG-grounded]] models while using LLMs for [[scaffolding]] and dialogue.
