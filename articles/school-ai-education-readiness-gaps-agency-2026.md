...
- **Sample:** 752 Hong Kong junior-secondary students (Mage = 14.06), 2024–25 school year, across three prior-learning profiles:
  ...
  - **[[curriculum-design|Curriculum]]-supported learners** (N = 369) — one year of school AI instruction only
...
- **Cognitive gaps persisted** — group differences in AI-literacy change were non-significant, and high-agency learners still outperformed peers at post-test; a [[digital-divide|Matthew-effect]] pattern where school AI education "raised the floor but did not fully level the playing field"
