...
- **The refined model explained 79.8% of the variance in behavioral intention:** Perceived usefulness was the dominant predictor of intention (.832), and perceived ease of use drove usefulness (.479), confirming the core [[technology-acceptance-model|TAM]] pathways after attitude was removed.
...
- **Explanatory [[mixed-methods-research|mixed methods]] design**, with a [[quantitative-research|quantitative]] questionnaire analyzed first and [[qualitative-research|qualitative]] open-ended responses used to interpret and extend the results.
