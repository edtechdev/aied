...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      { label: 'Core pedagogies', items: ['pedagogy', 'active-learning', 'learning-by-teaching', 'collaborative-learning', 'project-based-learning', 'problem-based-learning', 'inquiry-based-learning', 'experiential-learning', 'game-based-learning', 'scaffolding', 'socratic-method', 'self-regulated-learning', 'self-determination-theory', 'sociocultural-learning', 'desirable-difficulties', 'transfer-of-learning', 'metacognition', 'constructivist', 'behaviorism', 'learning-theories', 'theory-development-aied', 'distributed-cognition', 'situated-learning', 'embodied-learning', 'storytelling-in-education', 'instructional-design', 'online-teaching-and-learning'] },
