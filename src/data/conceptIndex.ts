...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      { label: 'The field', items: ['ai-education', 'misconceptions', 'history-of-aied', 'philosophy-of-ai-in-education', 'theory-development-aied', 'ai-literacy', 'computational-thinking'] },
