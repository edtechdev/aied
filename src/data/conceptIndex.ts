...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      ...
      { label: 'Learning theories and processes', items: ['motivation', 'self-efficacy', 'self-directed-learning', 'help-seeking', 'student-engagement', 'cognitive-diagnosis', 'community-of-inquiry', 'prior-knowledge', 'student-modeling', 'knowledge-tracing', 'student-misconceptions-ai', 'simulating-students', 'icap-framework', 'activity-theory-aied'] },
