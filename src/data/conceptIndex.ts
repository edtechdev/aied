...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      { label: 'Core pedagogies', items: ['active-learning', 'learning-by-teaching', 'teachable-agents', 'collaborative-learning', 'project-based-learning', 'experiential-learning', 'game-based-learning', 'gamification', 'scaffolding', 'socratic-method', 'self-regulated-learning', 'self-determination-theory', 'zone-of-proximal-development', 'desirable-difficulties', 'transfer-of-learning', 'metacognition', 'cognitive-load-theory', 'dual-process-theory', 'constructivist', 'embodied-learning', 'storytelling-in-education', 'instructional-design'] },
