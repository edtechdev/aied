...
export const conceptIndex: ConceptSection[] = [
  ...
  },
  {
    ...
    groups: [
      { label: 'Assessment and feedback', items: ['assessment', 'evaluative-judgment', 'feedback', 'feedback-literacy', 'ai-feedback-quality', 'formative-assessment', 'summative-assessment', 'authentic-assessment', 'process-oriented-assessment', 'group-work', 'eportfolio', 'peer-assessment', 'self-assessment', 'oral-assessment', 'automated-assessment', 'automated-essay-scoring', 'automated-question-generation'] },
