...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      ...
      { label: 'Subject areas', items: ['discipline-specific-aied', 'math-education', 'physics-education', 'language-learning', 'cs-education', 'programming-education', 'writing-education', 'stem-education', 'k-12-ai-education', 'special-education', 'adult-learning', 'higher-ed', 'medical-education', 'humanities-education', 'block-programming'] },
    ],
  },
  {
