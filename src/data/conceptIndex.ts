...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      ...
      { label: 'Subject areas', items: ['discipline-specific-aied', 'math-education', 'physics-education', 'language-learning', 'cs-education', 'writing-education', 'stem-education', 'teacher-education', 'medical-education', 'humanities-education', 'special-education', 'adult-learning', 'higher-ed'] },
    ],
  },
  {
