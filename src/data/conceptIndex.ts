...
export const conceptIndex: ConceptSection[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { label: 'Institutions and systems', items: ['administrator', 'educational-policy-ai', 'governance', 'guardrails', 'regulation', 'privacy', 'open-source', 'edtech-platform', 'learning-analytics', 'lifelong-learning', 'professional-training', 'career-development-and-readiness', 'k-12'] },
    ],
  },
  {
