...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      ...
      { label: 'Cross-cutting themes', items: ['misconceptions', 'human-ai-collaboration', 'agentic-ai', 'agency', 'learner-identity', 'design-thinking', 'curriculum-design', 'technology-acceptance-model', 'prompt-engineering', 'ai-use-disclosure'] },
    ],
  },
  {
