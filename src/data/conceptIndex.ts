...
export const conceptIndex: ConceptSection[] = [
  {
    ...
    groups: [
      { label: 'Core pedagogies', items: ['pedagogy', 'active-learning', 'learning-by-teaching', 'collaborative-learning', 'project-based-learning', 'problem-based-learning', 'productive-failure', 'inquiry-based-learning', 'experiential-learning', 'game-based-learning', 'scaffolding', 'socratic-method', 'self-regulated-learning', 'self-determination-theory', 'sociocultural-learning', 'desirable-difficulties', 'transfer-of-learning', 'metacognition', 'constructivist', 'behaviorism', 'learning-theories', 'theory-development-aied', 'distributed-cognition', 'situated-learning', 'embodied-learning', 'storytelling-in-education', 'instructional-design', 'online-teaching-and-learning'] },
      { label: 'Learning theories and processes', items: ['motivation', 'self-efficacy', 'self-directed-learning', 'help-seeking', 'student-engagement', 'cognitive-diagnosis', 'community-of-inquiry', 'prior-knowledge', 'student-modeling', 'knowledge-tracing', 'student-misconceptions-ai', 'simulating-students', 'icap-framework', 'activity-theory-aied', 'refutation-text'] },
  ...
  },
  {
    ...
    groups: [
      { label: 'Learners', items: ['stakeholders', 'student-experience', 'well-being', 'social-emotional-learning', 'ai-anxiety-and-stress', 'agency', 'creativity'] },
      { label: 'Teachers', items: ['teacher-role', 'teacher-ai-competency', 'tpack', 'faculty-development', 'pedagogical-safety'] },
      { label: 'Institutions and systems', items: ['administrator', 'educational-policy-ai', 'governance', 'guardrails', 'regulation', 'privacy', 'open-source', 'edtech-platform', 'learning-analytics', 'lifelong-learning', 'professional-training', 'career-development-and-readiness', 'k-12', 'early-childhood-elementary-ai-education'] },
    ],
  },
  {
