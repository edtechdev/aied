...
const ja: HomeStrings = {
  ...
  introHtml: `教育における<strong>AIナレッジベース</strong>へようこそ。これは<a href="/aied/concepts/ai-education/">教育における人工知能</a>に関する無料のパブリックドメインのリソースで、教育・学習・設計・運営に携わる方々に向けたものです。近年のオープンアクセス研究を、読んですぐに役立てられる短く構造化されたページにまとめています。作り方について少しお話しします。ページはAIエージェントが生成・更新し、サイト開発者が編集面で助言しています。すべての記述には根拠となる論文名を挙げているので、出典はご自分で確認できます。`,
  navHeading: 'サイトの見方',
