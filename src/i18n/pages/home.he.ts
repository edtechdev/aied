...
const he: HomeStrings = {
  title: 'דף הבית',
  h1: 'מאגר הידע לבינה מלאכותית בחינוך',
  introHtml: `ברוכים הבאים אל <strong>מאגר הידע לבינה מלאכותית בחינוך</strong> — משאב חופשי ונחלת הכלל בנושא <a href="/aied/concepts/ai-education/">בינה מלאכותית בחינוך</a>, למי שמלמד, לומד, מעצב או מנהל אותו. הוא מזקק מחקרים עדכניים בגישה פתוחה לעמודים קצרים ומובנים שאפשר לקרוא וליישם. הערה על אופן היצירה: את העמודים יוצר ומעדכן סוכן בינה מלאכותית, בליווי עריכתי של מפתח האתר. כל טענה מציינת את המאמר שעומד מאחוריה, כך שהמקורות זמינים לבדיקה.`,
