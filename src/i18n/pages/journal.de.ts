...
const de: JournalStrings = {
  title: 'Journal',
  h1: 'Journal',
  introTemplate:
    'Chronologisch absteigender Index aller {articles} Artikel, {concepts} Konzepte, {faqs} FAQs und {resources} Ressourcen in der Wissensbasis. {rss}',
  rssLabel: 'Den RSS-Feed abonnieren, um die neuesten Ergänzungen zu verfolgen.',
  pageSingular: 'Seite',
  pagePlural: 'Seiten',
};
