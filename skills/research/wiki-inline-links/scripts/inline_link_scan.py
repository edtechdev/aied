...
ALIASES = {
    ...
    'academic-misconduct-procedures': ['misconduct procedure', 'misconduct procedures', 'academic misconduct procedure',
                                       'academic misconduct procedures', 'misconduct policy', 'misconduct investigation',
                                       'misconduct hearing', 'procedural justice', 'burden of proof', 'standard of proof',
                                       'evidentiary standard', 'enforcement pyramid'],
    ...
    'explainable-ai': ['explainable ai', 'explainable artificial intelligence', 'xai', 'explainability',
                       'interpretability', 'interpretable ai', 'transparent ai', 'transparency',
                       'model explanation', 'post-hoc explanation', 'counterfactual explanation',
                       'feature importance', 'glass-box', 'black-box model', 'explaining the system', 'explanation quality'],
    ...
    'educational-development': ['professional development', 'staff development', 'faculty development'],
    ...
    'learning-design': ['instructional design', 'learning design', 'course design', 'course design decisions'],
    'storytelling-in-education': ['storytelling'],
    'video-education': ['educational video', 'educational videos', 'instructional video', 'instructional videos',
                        'video-based learning', 'video learning', 'video-based', 'lecture video', 'lecture videos',
                        'ai-generated video', 'ai-generated videos', 'ai video', 'ai-generated instructional video',
                        'ai-generated instructional videos', 'video generation', 'video content', 'video lectures',
                        'video lesson', 'video lessons', 'video-based instruction', 'instructional video generation',
                        'generated instructional videos', 'educational media'],
    'vibe-coding': ['vibe coding', 'vibe-coding', 'natural-language programming',
                     'natural language programming', 'end-user development', 'end user development',
                     'prompt-driven programming', 'building software by prompting'],
