...
6. **Verify before build:**
   ...
   - No same-text pipes, no heading links, no self-links, balanced brackets, no broken slugs (check against `content/en/concepts/` + `content/en/articles/` filenames + `conceptRedirects.ts`).
